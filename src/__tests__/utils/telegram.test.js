...
describe('Telegram Utils', () => {
  ...
  describe('sendTelegramNotification', () => {
    ...
    test('should create TelegramBot instance with correct config', async () => {
      await telegramUtils.default.sendTelegramNotification(mockConfig, mockFeedData);

      expect(mockTelegramBot).toHaveBeenCalledWith('test-bot-token', { polling: false });
    });
    ...
    test('should return result on successful message send', async () => {
      ...
      const result = await telegramUtils.default.sendTelegramNotification(mockConfig, mockFeedData);
    ...
    test('should handle empty description', async () => {
      ...
      await telegramUtils.default.sendTelegramNotification(mockConfig, feedDataWithEmptyDescription);
    ...
    test('should handle long messages properly', async () => {
      ...
      await telegramUtils.default.sendTelegramNotification(mockConfig, feedDataWithLongDescription);
    ...
    test('should handle special characters in message', async () => {
      ...
      await telegramUtils.default.sendTelegramNotification(mockConfig, feedDataWithSpecialChars);
    ...
    test('should handle missing config properties gracefully', async () => {
      ...
      await telegramUtils.default.sendTelegramNotification(incompleteConfig, mockFeedData);

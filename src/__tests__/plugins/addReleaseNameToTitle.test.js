...
const { default: addReleaseNameToTitle } = await import(
  "../../plugins/rss-braider/addReleaseNameToTitle.js"
);
...
describe("addReleaseNameToTitle Plugin", () => {
  ...
  test("should add release name to title for GitHub feeds", () => {
    ...
    mockUtils.getReleaseNameFromGitHubAndGitLabFeedLink.mockReturnValue(
      "owner/repo",
    );
    ...
    expect(
      mockUtils.getReleaseNameFromGitHubAndGitLabFeedLink,
    ).toHaveBeenCalledWith(itemOptions.url);
